...
from BD.Recuperations import (all_students,all_instructor,all_formations,all_modules, all_creneaux, all_rooms, all_seances, matiere_nb_groupe, matiere_nb_eleves, verif_affectation,seances_etudiant_p1,return_groupe_etudiant,all_seances_p1, all_seances_p2, etudiants_in_module)
from BD.Modifications import (modif_student_inscription,modif_seance,supp_student_inscription)
from Algorithme.Donnees import (liste_combinaisons_p1,liste_combinaisons_p2,affectation_combi_etudiant_p1,creation_groupe_p1,affectation_etudiants_groupe_p1,conflits1, calcul_conflits, algo1,affectation_etudiants_groupe_aleatoire_p1,algo1_aleatoire,algo2)
if __name__ == '__main__':
    ...
    if choix == "a":
        ...
        for groupe in groupe_initial:
            groupe.affichage()
        print("Liste des groupes après amélioration avec {} conflits".format(mesgroupes[3]))
        groupe_final = mesgroupes[2]
