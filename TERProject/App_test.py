...
from Algorithme.algoHybride import (generationGroupe)
from Algorithme.algoHybride import ListeEtudiants, ListeModules, generationGroupe
...
#TEST 
ListeModulesVoulus=all_modules()

for x in ListeModulesVoulus:
